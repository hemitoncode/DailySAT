...
import { CheckCircle2, XCircle, Flame, Trophy, Coins } from "lucide-react";
...
const SessionProgress: React.FC<SessionProgressProps> = ({
  ...
  return (
    <div>
      <div className="flex w-full rounded-t-lg items-center justify-between bg-blue-200 px-4 py-2 text-left text-sm font-bold text-slate-900">
      ...
      <div className="space-y-4 px-4 py-4 text-slate-900">
        ...
        <div className="flex flex-wrap justify-between gap-2 text-sm">
          ...
          <span className="flex items-center gap-1">
            <Coins className="h-4 w-4 text-yellow-600" /> Coins Earned:
