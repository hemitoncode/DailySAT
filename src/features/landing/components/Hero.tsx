...
import GradientUnderline from "@/shared/components/ui/GradientUnderline";
  ...
  return (
    <div className="relative w-screen min-h-[calc(100vh-5rem)] flex flex-col items-center justify-center text-center text-blue-900 font-figtree overflow-hidden py-6 md:py-20 space-y-5 md:space-y-7">
      ...
      <div className="relative z-10 flex flex-col items-center gap-y-0 sm:gap-y-0.5 leading-tight -mt-3 sm:-mt-4">
        ...
        >
          Simple and{" "}
          <GradientUnderline from="#0d4fff" to="rgba(13,79,255,0)">
            Effective
          </GradientUnderline>
          .
        </motion.h1>
      ...
      >
        ...
        <span className="relative inline-flex w-80 h-[2em] items-center justify-center overflow-hidden bg-white/20 border border-white/40 backdrop-blur-md shadow-lg rounded-md px-4 mx-1">
        ...
        <span>
          , we've got you with a plan, motivation, support, and results.
        </span>
      </motion.div>
