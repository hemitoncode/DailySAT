...
const AI = () => {
  ...
  const inputBase =
    "w-full px-3.5 py-2.5 border border-gray-200 rounded-xl bg-gray-50 text-sm text-gray-900 placeholder-gray-300 focus:outline-none focus:border-cyan-600 focus:bg-white focus:ring-2 focus:ring-cyan-600/10 transition";
    ...
    <div className="min-h-screen w-full bg-slate-50 font-sans">
      {step === 1 ? (
        <div className="flex flex-col min-h-screen w-full">
          {/* Top accent bar */}
          <div className="h-1 w-full bg-gradient-to-r from-cyan-900 via-cyan-600 to-cyan-400" />

          {/* Header */}
          <div className="w-full bg-white border-b border-gray-200 px-16 py-9">
            <p className="text-[10px] font-semibold tracking-[0.14em] uppercase text-cyan-600 mb-2">
              SAT Prep · AI Powered
            </p>
            <h1 className="text-4xl font-normal text-gray-900 tracking-tight leading-tight mb-2">
              Build your{" "}
              <em className="italic not-italic font-normal text-cyan-600">study plan.</em>
            </h1>
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-3 gap-5 w-full mb-5">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5">
                  <p className="text-[10px] font-semibold tracking-[0.12em] uppercase text-cyan-600 mb-2">
                    Current Score
                  </p>
                  <label
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 border border-cyan-200 rounded-xl bg-cyan-50 text-sm text-cyan-900 placeholder-cyan-200 focus:outline-none focus:border-cyan-600 focus:bg-white focus:ring-2 focus:ring-cyan-600/10 transition"
                  />
                  {scoreDelta !== null && scoreDelta > 0 && (
                    <div className="mt-2.5 inline-flex items-center gap-1.5 bg-cyan-50 border border-cyan-100 rounded-full px-2.5 py-1 text-[11px] font-semibold text-cyan-600">
              ...
              <div className="flex items-center gap-5">
                <button
                  type="submit"
                  disabled={isLoading}
                  className="flex-1 flex items-center justify-center gap-2 bg-cyan-600 hover:bg-cyan-700 active:bg-cyan-800 text-white text-sm font-semibold px-6 py-3.5 rounded-xl transition disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-lg hover:shadow-cyan-600/25 hover:-translate-y-px"
                >
                  {isLoading ? (
                    <>
        ...
        <div className="flex flex-col min-h-screen w-full">
          ...
          {/* Hero */}
          <div className="w-full bg-gradient-to-br from-cyan-900 to-cyan-700 px-16 py-10 flex items-center justify-between gap-6">
            <div className="flex flex-col gap-1.5">
              <p className="text-[10px] font-semibold tracking-[0.14em] uppercase text-cyan-300">
            ...
            {currentScore && targetScore && (
              <div className="flex items-center gap-3 shrink-0">
                <div className="flex flex-col items-center bg-white/10 border border-white/15 rounded-xl px-5 py-3">
                  ...
                  <span className="text-[10px] font-medium text-cyan-300 uppercase tracking-wider mt-1">Current</span>
                </div>
                <svg className="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
                <div className="flex flex-col items-center bg-cyan-300/15 border border-cyan-300/40 rounded-xl px-5 py-3">
                  <span className="text-2xl font-bold text-white tracking-tight leading-none">{targetScore}</span>
                  <span className="text-[10px] font-medium text-cyan-300 uppercase tracking-wider mt-1">Target</span>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="w-full bg-white border-b border-gray-200 px-16 py-3 flex items-center">
            <button
              onClick={resetForm}
              className="flex items-center gap-2 text-sm font-medium text-gray-500 bg-white border border-gray-200 rounded-lg px-3.5 py-2 hover:bg-cyan-50 hover:border-cyan-200 hover:text-cyan-600 transition"
            >
